...
- Get acquainted with the INCAtools framework for conveying all open
  biomedical ontologies in a common SQLite structure

- Program with several ontologies using ontoProc2

- Understand the role of Model Context Protocol in supporting natural
  language interrogation of ontologies, and integrate MCP responses with
  ontoProc2 programming

## Background

The [INCAtools Semantic SQL
project](https://github.com/INCATools/semantic-sql) ([tutorial
notebook](https://github.com/INCATools/semantic-sql/blob/main/notebooks/SemanticSQL-Tutorial.ipynb))
identifies an AWS S3 bucket where a large number of ontologies are
available.
...
In this workshop we will provide tools to retrieve, cache, and make use
of these ontologies.
